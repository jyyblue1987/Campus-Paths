...
public class MarvelParser {
     ...
     */
    public static HashMap<String, ArrayList<String>> parseData(String filename, ArrayList<String> characters) throws IOException {
        List<String> lines = readLines(filename);
        HashMap<String, ArrayList<String>> marvel = new HashMap<>();
        ...
        while(itr.hasNext()) {
            ...
            String comicBook = tokens[1];
            if(!marvel.containsKey(comicBook)) {
                marvel.put(comicBook, new ArrayList<>());
            }
            marvel.get(comicBook).add(character);
