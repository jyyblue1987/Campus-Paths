...
public final class RatPolyStack implements Iterable<RatPoly> {
    ...
    public void add() {
        ...
        RatPoly result = first.add(second);
        polys.push(result);
    }
    ...
    public void sub() {
        RatPoly first = polys.pop();
        RatPoly second = polys.pop();
        RatPoly result = second.sub(first);
        polys.push(result);
    }
    ...
    public void mul() {
        RatPoly first = polys.pop();
        RatPoly second = polys.pop();
        RatPoly result = first.mul(second);
        polys.push(result);
    }
    ...
    public void div() {
        RatPoly first = polys.pop();
        RatPoly second = polys.pop();
        RatPoly result = second.div(first);
        polys.push(result);
    }
    ...
    public void differentiate() {
        RatPoly first = polys.pop();
        RatPoly result = first.differentiate();
        polys.push(result);
    }
    ...
    public void integrate() {
        RatPoly first = polys.pop();
        RatPoly result = first.antiDifferentiate(new RatNum(0));
        polys.push(result);
    }
